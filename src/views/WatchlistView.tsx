        ...
        <div className="crystal-card overflow-hidden flex-grow flex flex-col">
          ...
          <div className="flex flex-col overflow-y-auto">
            ...
            <div className="grid grid-cols-12 gap-4 px-4 py-3 border-b border-surface-variant/50 hover:bg-surface-container transition-colors items-center group cursor-pointer pl-3">
              ...
              <div className="col-span-3 flex flex-col items-end justify-center">
                 <span className="text-[13px] font-bold text-on-surface font-mono">1,680.00</span>
                 <span className="text-[11px] font-bold gem-text-red bg-error/10 px-1.5 rounded mt-1 font-mono shadow-inner border border-error/20">+1.25%</span>
              </div>
              <div className="col-span-5 flex items-center justify-end gap-3">
                <div className="w-16 h-1.5 bg-surface-container rounded-full overflow-hidden relative shadow-inner border border-white/5 hidden sm:block">
                  <div className="absolute left-0 top-0 h-full gem-red w-[45%] rounded-full"></div>
                </div>
                <span className="text-[11px] font-bold gem-text-red flex items-center gap-0.5 min-w-[36px] justify-end">
            ...
            <div className="grid grid-cols-12 gap-4 px-4 py-3 border-b border-surface-container-highest hover:bg-surface-container transition-colors items-center group cursor-pointer pl-3">
              ...
              <div className="col-span-3 flex flex-col items-end justify-center">
                 <span className="text-[13px] font-bold text-on-surface font-mono">42.15</span>
                 <span className="text-[11px] font-bold gem-text-green bg-secondary/10 px-1.5 rounded mt-1 font-mono shadow-inner border border-secondary/20">-0.85%</span>
              </div>
              <div className="col-span-5 flex items-center justify-end gap-3">
                <div className="w-16 h-1.5 bg-surface-container rounded-full overflow-hidden relative shadow-inner border border-white/5 hidden sm:block">
                  <div className="absolute right-0 top-0 h-full gem-green w-[25%] rounded-full"></div>
                </div>
                <span className="text-[11px] font-bold gem-text-green flex items-center gap-0.5 min-w-[36px] justify-end">
